...
const DailyAttendanceView: FC<DailyAttendanceProps> = ({
    ...
    return (
        <div className="space-y-3 animate-in fade-in slide-in-from-bottom-4 pb-20">
            ...
            <div className={`flex gap-1 p-1 rounded-2xl w-fit border transition-all ${isDarkMode ? 'bg-slate-900/50 border-slate-800' : 'bg-indigo-50/30 border-indigo-100/50'}`}>
                <button
            ...
            {(activeSubTab === 'chamada' || activeSubTab === 'cupons') && (
                <div className={`rounded-3xl p-5 lg:p-6 border shadow-xl transition-all ${isDarkMode ? 'bg-slate-900/40 border-slate-800/50 backdrop-blur-xl' : 'bg-white border-indigo-100/50'}`}>
