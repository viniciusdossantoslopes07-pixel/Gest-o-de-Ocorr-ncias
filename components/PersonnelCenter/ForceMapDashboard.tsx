            ...
            <div className={`sticky top-0 z-40 ${gls} border shadow-2xl rounded-[1.5rem] sm:rounded-[2.5rem] px-4 sm:px-6 py-3 mt-2 flex flex-col lg:flex-row items-stretch lg:items-center justify-between gap-4 transition-all hover:shadow-blue-500/10`}>
                <div className="flex items-center gap-3 sm:gap-4">
                    <div className="relative shrink-0">
                        ...
                        <div className={`relative p-2 sm:p-3 rounded-2xl shadow-2xl ${dk ? 'bg-gradient-to-br from-blue-600 to-indigo-700' : 'bg-slate-900'} text-white`}>
                            <Shield className="w-4 h-4 sm:w-5 sm:h-5" />
                        </div>
                    </div>
                    <div>
                        <div className="flex items-center gap-2">
                            <h2 className={`text-base sm:text-lg font-black tracking-tight ${textPrimary}`}>MAPA DE FORÇA</h2>
                ...
                <div className="flex overflow-x-auto items-center gap-2 pb-1 sm:pb-0 scrollbar-hide snap-x">
                    <div className="shrink-0 flex items-center gap-1 p-1 rounded-2xl bg-slate-500/5 border border-slate-500/10">
                    ...
                    {viewMode === 'DAILY' ? (
                        <div className={`shrink-0 flex items-center gap-2 p-1.5 rounded-2xl bg-slate-500/5 border border-slate-500/10`}>
                    ...
                    <button
                        ...
                        className={`shrink-0 p-3 rounded-2xl transition-all shadow-lg active:scale-95 ${dk ? 'bg-blue-600 hover:bg-blue-500 text-white' : 'bg-slate-900 hover:bg-slate-800 text-white'}`}
                    >
