...
export const TIPOS_MISSAO = [
  ...
  "SEGURANÇA DE ANV PRESIDENCIAL ZPH",
  "POLICIAMENTO OSTENSIVO",
  "ESCOLTA DE MATBEL",
  "ESCOLTA DE PRESO",
  "ESCOLTA DE MATERIAL",
  "ESCOLTA DE AERONAVE",
  "EMPREGO DE CÃES (FARO)",
  "ALA DE AUTORIDADE",
  "PBCV",
  "BUSCA E APREENSÃO",
...
export const ARMAMENT_OPTIONS = ['Pistola', 'Fuzil', 'Gaúgio', 'Pist/Fuzil', 'Pist/Gáugio', 'Mosquetão'];
