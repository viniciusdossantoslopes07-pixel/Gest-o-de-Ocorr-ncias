                    ...
                    <div className="flex flex-col md:flex-row gap-6 items-start md:items-center mb-4">
                        ...
                        <div className="flex-1">
                            ...
                            <p className={`text-xs font-bold ${textSecondary}`}>
                                Gerenciamento de convidados e acesso
                            </p>
                        </div>
                    </div>
        ...
        <div className={`p-4 md:p-6 rounded-2xl border ${card} animate-fade-in`}>
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
                ...
                <div className="flex flex-col sm:flex-row w-full sm:w-auto items-stretch sm:items-center gap-3">
                    {/* View Mode Tabs */}
                    <div className={`flex w-full sm:w-auto p-1 rounded-xl ${dk ? 'bg-slate-900/60' : 'bg-slate-100'}`}>
                        <button
                            onClick={() => setViewMode('upcoming')}
                            className={`flex-1 sm:flex-none px-4 py-2.5 sm:py-2 rounded-lg text-xs font-black uppercase tracking-wide transition-all whitespace-nowrap ${viewMode === 'upcoming'
                        ...
                        <button
                            ...
                            className={`flex-1 sm:flex-none px-4 py-2.5 sm:py-2 rounded-lg text-xs font-black uppercase tracking-wide transition-all whitespace-nowrap ${viewMode === 'history'
                    ...
                    <button
                        onClick={fetchEvents}
                        disabled={loading}
                        className={`w-full sm:w-auto flex items-center justify-center gap-2 px-4 py-2.5 sm:py-2 rounded-xl text-xs font-black uppercase tracking-wide transition-all shadow-sm ${dk ? 'bg-blue-600/20 text-blue-400 hover:bg-blue-600/30' : 'bg-blue-50 text-blue-600 hover:bg-blue-100'}`}
                    >
