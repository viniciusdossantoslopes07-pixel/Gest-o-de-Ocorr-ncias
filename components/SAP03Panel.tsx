            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <div className="flex flex-wrap gap-3 w-full md:w-auto">
                    ...
                    <button
                        ...
                        className={`flex-1 md:flex-none px-6 py-2.5 rounded-xl font-black uppercase tracking-widest transition-all shadow-lg flex items-center justify-center gap-2 text-[10px] active:scale-95 ${activeTab === 'Em Uso' ? 'bg-red-500 text-white shadow-red-500/20' : 'bg-emerald-600 text-white hover:bg-emerald-700 shadow-emerald-500/20'}`}
                    >
