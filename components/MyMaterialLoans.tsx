    ...
    return (
        <div className="space-y-6 animate-fade-in max-w-7xl mx-auto">
            ...
            <div className={`p-4 rounded-[1.5rem] border shadow-sm flex flex-col md:flex-row justify-between items-center gap-4 transition-all ${isDarkMode ? 'bg-slate-900/40 border-slate-800/50 backdrop-blur-xl' : 'bg-white border-slate-100'}`}>
                ...
                <div className={`flex p-1 rounded-xl gap-1 w-full md:w-auto ${isDarkMode ? 'bg-slate-900/50' : 'bg-slate-100'}`}>
                    <button
            ...
            {/* Filter Bar */}
            <div className={`p-3 rounded-2xl border shadow-sm space-y-3 transition-all ${isDarkMode ? 'bg-slate-900/40 border-slate-800/50 backdrop-blur-xl' : 'bg-white border-slate-100'}`}>
                ...
                <div className="flex items-center justify-between gap-3 overflow-x-auto pb-1 scrollbar-hide">
                    <div className={`flex items-center gap-3 px-4 py-2.5 rounded-xl shrink-0 transition-all ${isDarkMode ? 'bg-slate-900/50 border border-slate-800/50' : 'bg-slate-50 border border-slate-100'}`}>
            ...
            {activeTab === 'estatisticas' ? (
                <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div className={`p-8 rounded-[2rem] border shadow-sm flex flex-col justify-between transition-all ${isDarkMode ? 'bg-slate-900/40 border-slate-800/50 backdrop-blur-xl' : 'bg-white border-slate-100 hover:shadow-xl hover:scale-[1.02]'}`}>
                        ...
                        <div className={`p-8 rounded-[2rem] border shadow-sm flex flex-col justify-between transition-all ${isDarkMode ? 'bg-slate-900/40 border-slate-800/50 backdrop-blur-xl' : 'bg-white border-slate-100'}`}>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        <div className={`p-8 rounded-[2rem] border shadow-sm transition-all ${isDarkMode ? 'bg-slate-900/40 border-slate-800/50 backdrop-blur-xl' : 'bg-white border-slate-100'}`}>
                                    ...
                                    loan.status === 'Aprovado' ? (isDarkMode ? 'border-blue-500/30 bg-blue-500/5' : 'border-blue-100 bg-blue-50/10') :
                                        loan.status === 'Em Uso' ? (isDarkMode ? 'border-emerald-500/30 bg-emerald-500/5 shadow-emerald-500/5' : 'border-emerald-100 bg-emerald-50/10') :
                                            loan.status === 'Rejeitado' ? (isDarkMode ? 'border-red-500/30 bg-red-500/5' : 'border-red-100 bg-red-50/10') :
                                                (isDarkMode ? 'bg-slate-900/40 border-slate-800/50 backdrop-blur-sm hover:border-blue-500/30 hover:bg-slate-800/60 shadow-sm' : 'bg-white border-slate-100 hover:border-blue-200 shadow-sm')
                                    }`}
                            >
